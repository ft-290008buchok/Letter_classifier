...
Представляет из себя мини frame work для создания и обучения нейросети методом обратного распространения ошибки для языка C++. Файл заголовка и файл реализации classifier вы можете найти в файлах проекта.
